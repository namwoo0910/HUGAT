...
def argument():
    ...
    parser.add_argument('--device', type=int, default=0, help='gpu no')
    parser.add_argument('--lr', type=float, default=1e-3, help='learning rate (defaults to 0.001)')
    parser.add_argument('--in-dims', type=int, default=350, help='input size (defaults to 350)')
    parser.add_argument('--repr-dims', type=int, default=48, help='embedding size (defaults to 48)')
    parser.add_argument('--num-heads', type=list, default=[12], help='number of heads')
    parser.add_argument('--epochs', type=int, default=2000, help='number of epochs')
    parser.add_argument('--seed', type=int, default=2, help='random seed')
    parser.add_argument('--weight', type=tuple, default=(0.1, 0.9, 1.0), help='weight')
...
def main():
    ...
    labels = data['labels']
    feats = utils.node_feats(args.in_dims).to(args.device)
